...
In this post, I'll be covering how to run the anticogging algorithm built into the ODrive with a v3.5 motor controller using firmware v0.5.1. (Edit: 20250523 - Anticogging at the time of publication was not a stable feature. I would check with the community to see if things are better these days. If this feature is required, other solutions may be a better fit.)
